...
#ifndef SPEAKWRITE_SWIFT_H
#define SPEAKWRITE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Speakwrite",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Speakwrite15CaptureTextView")
@interface CaptureTextView : UITextView
